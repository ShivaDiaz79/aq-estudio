...
const servicios = [
  {
    ...
    description: "Implica la creación de planos, maquetas y...",
    link: "/servicios/darquitectonico",
  },
  {
    title: "Planificación y Desarrollo del Proyecto",
    description: "Incluye establecer objetivos, plazos y presupuestos...",
    link: "/servicios/planificacion",
  },
  {
    title: "Remodelaciones",
    description: "Transformar espacios existentes en ambientes completamente...",
    link: "/servicios/remodelaciones",
  },
  {
    title: "Construciones",
    description: "Nos encargamos de gestionar todos los aspectos del proceso...",
    link: "/servicios/construciones",
  },
  {
    title: "Supervisión de Construcción",
    description: "Servicio vital para asegurar que el proyecto se construya...",
    link: "/servicios/supervision",
  },
  {
    title: "Diseño de Interiores",
    description: "Creación de espacios interiores atractivos y funcionales...",
        ...
        <ul key={index}>
          <li>
            <Link
              ...
              className="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <div className="font-semibold">{servicio.title}</div>
              <span className="text-sm text-gray-500 dark:text-gray-400">
